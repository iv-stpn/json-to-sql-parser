...
describe("Integration - Row-Level Security (RLS) Access Control Simulation", () => {
	...
	beforeAll(async () => {
		...
		config = {
			...
			relationships: [
				{ table: "teams", field: "organization_id", toTable: "organizations", toField: "id" },
				{ table: "team_members", field: "team_id", toTable: "teams", toField: "id" },
				{ table: "team_members", field: "user_id", toTable: "users", toField: "id" },
				{ table: "team_members", field: "role_id", toTable: "roles", toField: "id" },
				{ table: "projects", field: "team_id", toTable: "teams", toField: "id" },
				{ table: "projects", field: "owner_id", toTable: "users", toField: "id" },
				{ table: "project_access", field: "project_id", toTable: "projects", toField: "id" },
				{ table: "project_access", field: "user_id", toTable: "users", toField: "id" },
				{ table: "project_access", field: "role_id", toTable: "roles", toField: "id" },
				{ table: "tasks", field: "project_id", toTable: "projects", toField: "id" },
				{ table: "tasks", field: "assignee_id", toTable: "users", toField: "id" },
				{ table: "tasks", field: "reporter_id", toTable: "users", toField: "id" },
			],
		};
	});
